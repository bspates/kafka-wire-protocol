      ...
      switch(entry[key]) {
        ...
        case 'messageSet': {
          ...
          data[key].forEach((message) => {
            ...
            let msgTmpl = Message.versions[msgVersion];
            let bodyStartOffset = msgOffset + msgTmpl.header_size;
      ...
      switch(entry[key]) {
        ...
        case 'messageSet': {
          ...
          while(endOffset > offset) {
            ...
            let postCrcOffset = offset + Message.header_size;

            var message;
            [message, offset] = Parser.decode(Message.template, buffer, offset);
